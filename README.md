...
- This includes activating endless mode, leaving the bathroom, entering the backroom, picking up the waiver, entering the name, taking the items, and opening the breifcase at the end of a run
